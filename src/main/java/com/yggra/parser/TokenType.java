...
public enum TokenType {
    ...
    CREATE, INSERT, INTO, VALUES, TABLE, DATABASE, USE, DROP, SHOW, DATABASES, CURRENT, TABLES, ALTER, RENAME, NONE,ADD, COLUMN, TO, DEFAULT, TRUNCATE, REMOVE, FROM, IN, MODIFY ,SET,FOR,NULL,
